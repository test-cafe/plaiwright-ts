...
const randomPriceCents = (minDollars: number, maxDollars: number) => {
...
async function up() {
  ...
  await prisma.story.createMany({
    data: [
      { previewImageUrl: '/img/pizza%20fest.png' },
      { previewImageUrl: '/img/did%20you%20recognize.png' },
      { previewImageUrl: '/img/fact%20of%20the%20day%20.jpeg' },
      { previewImageUrl: '/img/selection.png' },
      { previewImageUrl: '/img/meat%20free.png' },
      { previewImageUrl: '/img/coffee%20with%20flavour.png' },
    ],
  });
